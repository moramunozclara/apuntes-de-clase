...
// console.log(texto.match(/h?[aeiou]{2}l[aeiou]/ig));        // * condicional, da igual si un caracter está o si se repite (hielo)
console.log(texto.match(/h?[aeiou]{1,2}l[aeiou]/ig));        // * condicional, da igual si un caracter está o si se repite (hielo)
